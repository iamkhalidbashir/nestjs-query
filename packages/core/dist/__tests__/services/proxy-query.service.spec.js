...
describe('ProxyQueryService', () => {
    ...
    afterEach(() => (0, ts_mockito_1.reset)(mockQueryService));
    const queryService = new proxy_query_service_1.ProxyQueryService((0, ts_mockito_1.instance)(mockQueryService));
    ...
    it('should proxy to the underlying service when calling createMany', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.createMany(entities)).thenResolve(entities);
    ...
    it('should proxy to the underlying service when calling createOne', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.createOne(entity)).thenResolve(entity);
    ...
    it('should proxy to the underlying service when calling deleteMany', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.deleteMany(filter)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling deleteOne', () => {
        const result = { foo: 'bar' };
        (0, ts_mockito_1.when)(mockQueryService.deleteOne(1, undefined)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling findById', () => {
        const result = { foo: 'bar' };
        (0, ts_mockito_1.when)(mockQueryService.findById(1, undefined)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling getById', () => {
        const result = { foo: 'bar' };
        (0, ts_mockito_1.when)(mockQueryService.getById(1, undefined)).thenResolve(result);
        return expect(queryService.getById(1)).resolves.toBe(result);
    });
    it('should proxy to the underlying service when calling query', () => {
        const query = {};
        const result = [{ foo: 'bar' }];
        (0, ts_mockito_1.when)(mockQueryService.query(query)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling aggregate', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.aggregate(filter, aggregate)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling count', () => {
        const query = {};
        const result = 1;
        (0, ts_mockito_1.when)(mockQueryService.count(query)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling aggregateRelations with one dto', () => {
        ...
        const result = [{ count: { foo: 1 } }];
        (0, ts_mockito_1.when)(mockQueryService.aggregateRelations(TestType, relationName, dto, filter, aggQuery)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling aggregateRelations with many dtos', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.aggregateRelations(TestType, relationName, dtos, filter, aggQuery)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling updateMany', () => {
        ...
        (0, ts_mockito_1.when)(mockQueryService.updateMany(update, filter)).thenResolve(result);
    ...
    it('should proxy to the underlying service when calling updateOne', () => {
        ...
        const update = { foo: 'bar' };
        const result = { foo: 'bar' };
        (0, ts_mockito_1.when)(mockQueryService.updateOne(id, update, undefined)).thenResolve(result);
