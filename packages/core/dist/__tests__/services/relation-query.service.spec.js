...
describe('RelationQueryService', () => {
    ...
    const mockRelationService = (0, ts_mockito_1.mock)();
    const testRelationFn = jest.fn();
    class TestType {
    }
    const relations = {
        test: { service: (0, ts_mockito_1.instance)(mockRelationService), query: testRelationFn },
    };
    afterEach(() => {
        (0, ts_mockito_1.reset)(mockQueryService);
        (0, ts_mockito_1.reset)(mockRelationService);
        jest.clearAllMocks();
    });
    const queryService = new src_1.RelationQueryService((0, ts_mockito_1.instance)(mockQueryService), relations);
    it('should set the underlying service to a NoOpQueryService if called without a query service', () => expect(new src_1.RelationQueryService(relations).query({})).rejects.toThrow('query is not implemented'));
    describe('#addRelations', () => {
        it('should proxy to the underlying service when calling addRelations', () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.addRelations(relationName, id, relationIds, undefined)).thenResolve(result);
    ...
    describe('#findRelation', () => {
        it('should proxy to the underlying service when calling findRelation with one dto', async () => {
            ...
            (0, ts_mockito_1.when)(mockRelationService.query((0, ts_mockito_1.deepEqual)({ ...query, paging: { limit: 1 } }))).thenResolve([result]);
        ...
        it('should call the relationService findRelation with multiple dtos', async () => {
            ...
            (0, ts_mockito_1.when)(mockRelationService.query((0, ts_mockito_1.deepEqual)({ ...query, paging: { limit: 1 } }))).thenResolve(resultRelations);
        ...
        it('should call the original service if the relation is not in this relation query service', async () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.findRelation(TestType, relationName, dto, undefined)).thenResolve(result);
        ...
        it('should call the original service if the relation is not in this relation query service with multiple DTOs', async () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.findRelation(TestType, relationName, dtos, undefined)).thenResolve(result);
    ...
    describe('#queryRelations', () => {
        it('should proxy to the underlying service when calling queryRelations with one dto', async () => {
            ...
            (0, ts_mockito_1.when)(mockRelationService.query((0, ts_mockito_1.deepEqual)({ ...relationQuery }))).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos', () => {
            ...
            testRelationFn.mockReturnValue(relationQuery);
            (0, ts_mockito_1.when)(mockRelationService.query((0, ts_mockito_1.deepEqual)({ ...relationQuery }))).thenResolve(relationResult);
        ...
        it('should proxy to the underlying service when calling queryRelations with one dto and a unknown relation', () => {
            ...
            const query = {};
            const result = [{ foo: 'bar' }];
            (0, ts_mockito_1.when)(mockQueryService.queryRelations(TestType, relationName, dto, query)).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos and a unknown relation', () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.queryRelations(TestType, relationName, dtos, query)).thenResolve(result);
    ...
    describe('#aggregateRelations', () => {
        it('should proxy to the underlying service when calling queryRelations with one dto', async () => {
            ...
            (0, ts_mockito_1.when)(mockRelationService.aggregate((0, ts_mockito_1.deepEqual)(relationFilter), relationAggregateQuery)).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos', async () => {
            ...
            const relationAggregateQuery = { count: ['foo'] };
            testRelationFn.mockReturnValue({ filter: relationFilter });
            (0, ts_mockito_1.when)(mockRelationService.aggregate((0, ts_mockito_1.deepEqual)(relationFilter), relationAggregateQuery)).thenResolve(relationResults);
        ...
        it('should proxy to the underlying service when calling queryRelations with one dto and a unknown relation', () => {
            ...
            const result = [{ count: { foo: 1 } }];
            (0, ts_mockito_1.when)(mockQueryService.aggregateRelations(TestType, relationName, dto, filter, aggregateQuery)).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos and a unknown relation', () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.aggregateRelations(TestType, relationName, dtos, filter, aggregateQuery)).thenResolve(result);
    ...
    describe('#countRelations', () => {
        it('should proxy to the underlying service when calling queryRelations with one dto', async () => {
            ...
            const relationQuery = {};
            testRelationFn.mockReturnValue(relationQuery);
            (0, ts_mockito_1.when)(mockRelationService.count((0, ts_mockito_1.deepEqual)({ ...relationQuery }))).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos', () => {
            ...
            const result = new Map([[dtos[0], relationResult]]);
            testRelationFn.mockReturnValue(relationQuery);
            (0, ts_mockito_1.when)(mockRelationService.count((0, ts_mockito_1.deepEqual)({ ...relationQuery }))).thenResolve(relationResult);
        ...
        it('should proxy to the underlying service when calling queryRelations with one dto and a unknown relation', () => {
            ...
            const query = {};
            const result = 1;
            (0, ts_mockito_1.when)(mockQueryService.countRelations(TestType, relationName, dto, query)).thenResolve(result);
        ...
        it('should proxy to the underlying service when calling queryRelations with many dtos and a unknown relation', () => {
            ...
            (0, ts_mockito_1.when)(mockQueryService.countRelations(TestType, relationName, dtos, query)).thenResolve(result);
    ...
    describe('#removeRelation', () => {
        it('should proxy to the underlying service when calling removeRelation', () => {
            ...
            const relationId = 2;
            const result = { foo: 'bar' };
            (0, ts_mockito_1.when)(mockQueryService.removeRelation(relationName, id, relationId, undefined)).thenResolve(result);
    ...
    describe('#removeRelations', () => {
        it('should proxy to the underlying service when calling removeRelations', () => {
            ...
            const relationIds = [2];
            const result = { foo: 'bar' };
            (0, ts_mockito_1.when)(mockQueryService.removeRelations(relationName, id, relationIds, undefined)).thenResolve(result);
    ...
    describe('#setRelation', () => {
        it('should proxy to the underlying service when calling setRelation', () => {
            ...
            const relationId = 2;
            const result = { foo: 'bar' };
            (0, ts_mockito_1.when)(mockQueryService.setRelation(relationName, id, relationId, undefined)).thenResolve(result);
    ...
    describe('#setRelations', () => {
        it('should proxy to the underlying service when calling setRelations', () => {
            ...
            const relationIds = [2];
            const result = { foo: 'bar' };
            (0, ts_mockito_1.when)(mockQueryService.setRelations(relationName, id, relationIds, undefined)).thenResolve(result);
