import { Query, DeleteManyResponse, UpdateManyResponse, DeepPartial, QueryService, Filter, AggregateQuery, AggregateResponse, FindByIdOptions, GetByIdOptions, UpdateOneOptions, DeleteOneOptions } from '@nestjs-query/core';
