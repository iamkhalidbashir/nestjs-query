...
const custom_id_scalar_1 = require("../../common/custom-id.scalar");
const sub_task_dto_1 = require("../../sub-task/dto/sub-task.dto");
const tag_dto_1 = require("../../tag/dto/tag.dto");
let TodoItemDTO = class TodoItemDTO {
};
(0, tslib_1.__decorate)([
    (0, query_graphql_1.IDField)(() => custom_id_scalar_1.CustomIDScalar),
...
(0, tslib_1.__decorate)([
    (0, query_graphql_1.FilterableField)(() => graphql_1.GraphQLISODateTime, { filterOnly: true }),
...
TodoItemDTO = (0, tslib_1.__decorate)([
    ...
    (0, query_graphql_1.CursorConnection)('subTasks', () => sub_task_dto_1.SubTaskDTO, { disableRemove: true }),
    (0, query_graphql_1.CursorConnection)('tags', () => tag_dto_1.TagDTO)
], TodoItemDTO);
