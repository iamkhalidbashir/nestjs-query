...
TodoItemDTO = (0, tslib_1.__decorate)([
    ...
    (0, query_graphql_1.CursorConnection)('subTasks', () => sub_task_dto_1.SubTaskDTO, { disableRemove: true, complexity: 5 }),
    (0, query_graphql_1.CursorConnection)('tags', () => tag_dto_1.TagDTO, { complexity: 10 })
], TodoItemDTO);
