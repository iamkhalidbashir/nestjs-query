...
const query_typegoose_1 = require("@nestjs-query/query-typegoose");
    ...
    (0, common_1.Module)({
        ...
        imports: [
            query_graphql_1.NestjsQueryGraphQLModule.forFeature({
                imports: [query_typegoose_1.NestjsQueryTypegooseModule.forFeature([todo_item_entity_1.TodoItemEntity])],
