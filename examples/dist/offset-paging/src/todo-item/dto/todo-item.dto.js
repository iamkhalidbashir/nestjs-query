...
TodoItemDTO = (0, tslib_1.__decorate)([
    ...
    (0, query_graphql_1.QueryOptions)({ pagingStrategy: query_graphql_1.PagingStrategies.OFFSET, enableTotalCount: true }),
    (0, query_graphql_1.OffsetConnection)('subTasks', () => sub_task_dto_1.SubTaskDTO, { disableRemove: true }),
    (0, query_graphql_1.OffsetConnection)('tags', () => tag_dto_1.TagDTO)
], TodoItemDTO);
