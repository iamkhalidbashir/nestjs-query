...
describe('Federated - SubTaskResolver (e2e)', () => {
    ...
    beforeAll(async () => {
        ...
        await app.init();
        await (0, __fixtures__1.refresh)(app.get(typeorm_1.Connection));
    });
    afterAll(() => (0, __fixtures__1.refresh)(app.get(typeorm_1.Connection)));
    const subTasks = [
    ...
    describe('query', () => {
        it(`should return a connection`, () => (0, supertest_1.default)(app.getHttpServer())
            ...
            query: `{
          subTasks {
            ${__fixtures__1.pageInfoField}
            ${(0, __fixtures__1.edgeNodes)(__fixtures__1.subTaskFields)}
          }
        }`,
        })
            .expect(200)
