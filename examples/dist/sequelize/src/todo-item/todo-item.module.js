...
const todo_item_tag_entity_1 = require("./entity/todo-item-tag.entity");
const todo_item_assembler_1 = require("./todo-item.assembler");
const todo_item_entity_1 = require("./entity/todo-item.entity");
    ...
    (0, common_1.Module)({
        ...
        imports: [
            query_graphql_1.NestjsQueryGraphQLModule.forFeature({
                imports: [query_sequelize_1.NestjsQuerySequelizeModule.forFeature([todo_item_entity_1.TodoItemEntity, todo_item_tag_entity_1.TodoItemEntityTags])],
