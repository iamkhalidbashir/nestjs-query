...
describe('SubTaskResolver (auth - e2e)', () => {
    ...
    describe('find one', () => {
        ...
        it(`should return a todo item relation`, () => (0, supertest_1.default)(app.getHttpServer())
            .post('/graphql')
            .auth(jwtToken, { type: 'bearer' })
            .send({
            operationName: null,
    ...
    describe('delete many', () => {
        it('should require an auth token', () => (0, supertest_1.default)(app.getHttpServer())
            ...
            .expect(200)
            .then(({ body }) => expect(body.errors[0].message).toBe('Unauthorized')));
        it('should allow deleting multiple subTasks', () => (0, supertest_1.default)(app.getHttpServer())
            .post('/graphql')
            .auth(jwtToken, { type: 'bearer' })
            .send({
            operationName: null,
    ...
    describe('setTodoItemOnSubTask', () => {
        ...
        it('should not allow setting a the todoItem that does not belong to the user on a subTask', () => (0, supertest_1.default)(app.getHttpServer())
            .post('/graphql')
            .auth(jwtToken, { type: 'bearer' })
            .send({
            operationName: null,
        ...
        it('should not allow setting a the todoItem on a subTask that does not belong to the user', () => (0, supertest_1.default)(app.getHttpServer())
            .post('/graphql')
            .auth(jwtToken, { type: 'bearer' })
            .send({
            operationName: null,
