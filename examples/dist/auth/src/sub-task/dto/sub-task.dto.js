...
const sub_task_authorizer_1 = require("../sub-task.authorizer");
...
(0, tslib_1.__decorate)([
    (0, query_graphql_1.FilterableField)({ nullable: true }),
    (0, tslib_1.__metadata)("design:type", String)
], SubTaskDTO.prototype, "createdBy", void 0);
(0, tslib_1.__decorate)([
    (0, query_graphql_1.FilterableField)({ nullable: true }),
    (0, tslib_1.__metadata)("design:type", String)
], SubTaskDTO.prototype, "updatedBy", void 0);
SubTaskDTO = (0, tslib_1.__decorate)([
    (0, graphql_1.ObjectType)('SubTask'),
    (0, query_graphql_1.QueryOptions)({ enableTotalCount: true }),
    (0, query_graphql_1.Authorize)(sub_task_authorizer_1.SubTaskAuthorizer),
    (0, query_graphql_1.Relation)('owner', () => user_dto_1.UserDTO, { disableRemove: true, disableUpdate: true }),
    (0, query_graphql_1.FilterableRelation)('todoItem', () => todo_item_dto_1.TodoItemDTO, { disableRemove: true })
], SubTaskDTO);
