...
], TodoItemDTO.prototype, "createdAt", void 0);
(0, tslib_1.__decorate)([
    (0, query_graphql_1.FilterableField)(() => graphql_1.GraphQLISODateTime),
    (0, tslib_1.__metadata)("design:type", Date)
], TodoItemDTO.prototype, "updatedAt", void 0);
(0, tslib_1.__decorate)([
    (0, graphql_1.Field)(),
...
TodoItemDTO = (0, tslib_1.__decorate)([
    ...
    (0, query_graphql_1.CursorConnection)('subTasks', () => sub_task_dto_1.SubTaskDTO, { disableRemove: true, guards: [auth_guard_1.AuthGuard] }),
    (0, query_graphql_1.CursorConnection)('tags', () => tag_dto_1.TagDTO, { guards: [auth_guard_1.AuthGuard] })
], TodoItemDTO);
